...
from apps.authentication.views import RegistrationView, ConfirmSignUpView, TwoFactorAuthenticationView, ProfileEdit
...
urlpatterns = [
    ...
    url(r'profile/', ProfileEdit.as_view(), name='account_edit')
